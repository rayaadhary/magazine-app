...
export default function AdminEdit() {
  ...
  return (
    <section className="p-6 sm:p-10 lg:p-14" data-testid="admin-edit-page">
      <button
      ...
      <form onSubmit={handleSubmit} className="max-w-[480px] space-y-6" data-testid="admin-edit-form">
        {error && (
          <div className="bg-danger/15 text-danger px-4 py-2.5 rounded-md text-sm font-medium border border-danger/15" data-testid="admin-edit-error">
            {error}
          </div>
        )}
