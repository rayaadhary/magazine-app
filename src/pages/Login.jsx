...
export default function Login() {
  ...
  return (
    <div className="min-h-[calc(100vh-72px)] bg-navy text-white" data-testid="login-page">
        ...
        <div className="flex flex-col justify-between px-7 py-8 sm:px-16">
          ...
          <div className="mx-auto w-full max-w-[340px] my-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-5" data-testid="login-form">
              {error && (
                <div className="bg-danger/15 text-danger px-4 py-2.5 rounded-md text-sm font-medium border border-danger/15" data-testid="login-error">
                  {error}
                </div>
              )}
              <div>
